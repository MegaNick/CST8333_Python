...
#Supportive class calculator performs arithmetics
class calc:
    """
    Supporting Class for arithmetic demonstration. Has methods of 4 basic arithmetic functions: + - * /
    By Nikolay Melnik
    """
...
def main():
    ...
    a=b #copying to a value of b
    print('a=b = ', a) #One variable is equal to another
    ...
    c = a #C has the same reference as a
    print('a is ', end='')
    ...
    #4 Repetition structures by Nikolay Melnik
    ...
    #5 Arithmetics by Nikolay Melnik
    print('5. Arithmetics by Nikolay Melnik')
    #Arithmetics implementation by Nikolay Melnik
    ...
    #6 Comparison. Simple compare examples by Nikolay Melnik
    #equal
    print('6. Comparision examples by Nikolay Melnik')
    ...
    #7 Logic operators by Nikolay Melnik
    print('7. Logic operators by Nikolay Melnik')
